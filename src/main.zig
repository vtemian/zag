...
//! wire the core subsystems (provider, registry, Lua, session, terminal,
//! screen, layout, compositor, theme), then hand the event loop off to
//! EventOrchestrator. Anything event-loop-shaped lives there.
